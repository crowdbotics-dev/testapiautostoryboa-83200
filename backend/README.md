...
## Project Structure
    ...
    ├── testapiautostoryboa_83200  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_83200`
...
2. Clone this repo and `cd testapiautostoryboa_83200`
